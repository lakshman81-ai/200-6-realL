...
export const Datatable3D_Smart_Fixer = () => {
    ...
    // Dynamically find all COMPONENT-ATTRIBUTE keys across all components to create columns
    ...
    const caColumns = Array.from(dynamicColumns).sort((a, b) => parseInt(a.replace('COMPONENT-ATTRIBUTE', '')) - parseInt(b.replace('COMPONENT-ATTRIBUTE', '')));
